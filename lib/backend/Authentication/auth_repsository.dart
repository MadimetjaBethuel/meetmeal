...
class AuthRepository {
  ...
  Future<String> attemptingAutoLogin() async {
    try {
      final session = await Amplify.Auth.fetchAuthSession();

      return session.isSignedIn ? (await getUserIdFromAttributes()) : null;
    } catch (e) {
      throw e;
    }
  }
  ...
  Future<String> login({
    ...
    final options =
        CognitoSignInOptions(clientMetadata: {'email': email.trim()});
    try {
